...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference("Phase.count") do
      post phases_url, params: { phase: { description: @phase.description, differentiation: @phase.differentiation, duration: @phase.duration, materials: @phase.materials, social: @phase.social } }
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { description: @phase.description, differentiation: @phase.differentiation, duration: @phase.duration, materials: @phase.materials, social: @phase.social } }
